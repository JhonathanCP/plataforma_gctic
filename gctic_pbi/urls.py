...
from pbi.views import CustomUserListCreateView, CustomUserRetrieveUpdateDeleteView, SolicitudApproveDenyView, SolicitudRetrieveUpdateDeleteView,GrupoListCreateView, GrupoRetrieveUpdateDeleteView, ReporteListCreateView, ReporteRetrieveUpdateDestroyView, PermisoGrupoListCreateView, PermisoReporteListCreateView, AsignarPermisoGrupoView, AsignarPermisoReporteView, AsignarTodosLosPermisosView, QuitarPermisoGrupoView, QuitarPermisoReporteView, PermisosUsuarioView, CambiarContrasenaView
